  ...
  const vm = new Vue({
    ...
    methods: {
      setAuthenticated(status, data) {
        ...
        // so set the user authenticated property to treu, and also store the user
        this.authenticated = status;
        this.administrator = parseInt(data.isadmin); // make sure this is a number, not text. parse integer
        this.user = data;
      },
