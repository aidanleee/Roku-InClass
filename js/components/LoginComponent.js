    ...
    methods: {
        login() {
            ...
            if (this.input.username != "" && this.input.password != "") {
                ...
                .then(data => {
                    console.log(data);
                    // we got a user back, let's set authentication and such
                    this.$emit("authenticated", true, data[0]); //data[0] is identifying the user id 
                    // reroute to the users componenet so we can see all of them
